...
const Mieterstrom = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <SubcategoryTabs activeSubcategory="mieterstrom" />
      
      <main id="main-content" className="flex-grow bg-background">
        <div className="container mx-auto px-6 py-8">
          <h1 className="text-3xl font-bold mb-6">Mieterstrom</h1>
              ...
              <Card className="mt-6">
                <CardContent className="pt-6">
                  ...
                  <ul className="text-sm space-y-2 text-muted-foreground list-disc pl-5">
                    <li>Bewertung Mieterstrommodelle</li>
                    <li>Prozessanalyse Anmeldung</li>
                    <li>Transparenz der Tarife</li>
                    <li>Digitale Abwicklung</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
