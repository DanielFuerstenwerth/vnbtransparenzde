    ...
    <div className="border-b border-border bg-background">
      <div className="container mx-auto px-6">
        <div className="flex items-center space-x-4">
          ...
          >
            <button
              onClick={() => onCategoryChange("dezentrale-ew")}
            ...
            {showDropdown && (
              <div className="absolute top-full left-0 mt-0 bg-background border border-border rounded-b-lg shadow-lg z-[100] min-w-[300px]">
                <ul className="py-2">
